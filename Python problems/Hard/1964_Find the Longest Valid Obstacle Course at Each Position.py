...
if __name__ == '__main__':
    ...
    print(s.longestObstacleCourseAtEachPosition([1, 2, 3, 2, 2, 2, 3, 1]))
    print(s.longestObstacleCourseAtEachPosition([1, 2, 3, 2, 2, 2, 3, 1, 2, 3, 4, 5, 6, 7, 8]))
